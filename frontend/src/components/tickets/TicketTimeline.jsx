  ...
  <ol className="space-y-4">
    {logs.map((log) => (
      <li key={log.id} className="relative pl-7">
        <span className="absolute left-0 top-1.5 h-3 w-3 rounded-full bg-campus-500 shadow-[0_0_0_4px_rgba(59,130,246,0.15)]" />
        <div className="rounded-xl border border-slate-200 bg-slate-50/90 p-3 dark:border-slate-700 dark:bg-slate-800/80">
