...
public final class AssignmentScorer {
    ...
    private static final double SPECIALIZATION_MATCH_WEIGHT = 30.0;
    ...
    public static double scoreCandidate(AssignmentCandidateMetrics candidate) {
        ...
        double specializationScore = candidate.specializationMatch() ? SPECIALIZATION_MATCH_WEIGHT : 0.0;
        ...
        return workloadScore + specializationScore + serviceDomainScore + buildingScore + recentResolutionScore;
    }
}
